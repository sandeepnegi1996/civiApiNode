...
ddb.getItem(params, function(err, data) {
  if (err) {
    ...
    // console.log("success", data.Item.data["M"].state["M"].reported["M"]);
    var objtest = data.Item.data["M"].state["M"].reported["M"];
    console.log(objtest.color);
    console.log(objtest.temperature);
